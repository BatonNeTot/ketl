...
#define KETL_HIR_TYPE_INSTR_SHIFT       4
    ...
    __KETL_HIR_BITWISE_AND,
    __KETL_HIR_BITWISE_OR,
    __KETL_HIR_BITWISE_XOR, 

    __KETL_HIR_BITWISE_SHIFT_LEFT,    
    __KETL_HIR_BITWISE_SHIFT_RIGHT, 
    ...
    __KETL_HIR_ASSIGN,    
    __KETL_HIR_ASSIGN_PLUS,    
    __KETL_HIR_ASSIGN_MINUS,    
    __KETL_HIR_ASSIGN_MULTY,    
    __KETL_HIR_ASSIGN_DIV,    
    __KETL_HIR_ASSIGN_MOD,  
      
    __KETL_HIR_ASSIGN_BITWISE_AND,    
    __KETL_HIR_ASSIGN_BITWISE_OR,    
    __KETL_HIR_ASSIGN_BITWISE_XOR,     
    ...
    KETL_HIR_BITWISE_AND              = __KETL_HIR_BITWISE_AND << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_BITWISE_OR               = __KETL_HIR_BITWISE_OR << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_BITWISE_XOR              = __KETL_HIR_BITWISE_XOR << KETL_HIR_TYPE_INSTR_SHIFT,

    KETL_HIR_BITWISE_SHIFT_LEFT       = __KETL_HIR_BITWISE_SHIFT_LEFT << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_BITWISE_SHIFT_RIGHT      = __KETL_HIR_BITWISE_SHIFT_RIGHT << KETL_HIR_TYPE_INSTR_SHIFT,
    ...
    KETL_HIR_ASSIGN_PLUS              = __KETL_HIR_ASSIGN_PLUS << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_ASSIGN_MINUS             = __KETL_HIR_ASSIGN_MINUS << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_ASSIGN_MULTY             = __KETL_HIR_ASSIGN_MULTY << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_ASSIGN_DIV               = __KETL_HIR_ASSIGN_DIV << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_ASSIGN_MOD               = __KETL_HIR_ASSIGN_MOD << KETL_HIR_TYPE_INSTR_SHIFT,

    KETL_HIR_ASSIGN_BITWISE_AND       = __KETL_HIR_ASSIGN_BITWISE_AND << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_ASSIGN_BITWISE_OR        = __KETL_HIR_ASSIGN_BITWISE_OR << KETL_HIR_TYPE_INSTR_SHIFT,
    KETL_HIR_ASSIGN_BITWISE_XOR       = __KETL_HIR_ASSIGN_BITWISE_XOR << KETL_HIR_TYPE_INSTR_SHIFT,
