...
typedef uint8_t ketl_hir_pos_tag_t;
...
KETL_DEFINE(ketl_hir_pos_col_t) {
    uint16_t col_index;
};

KETL_DEFINE(ketl_hir_pos_line_t) {
    int16_t line_diff;
    uint16_t col_index;
};

KETL_DEFINE(ketl_hir_pos_file_t) {
...
KETL_DEFINE(ketl_hir_header_t) {
    ketl_hir_tag_t tag;
    ketl_hir_pos_tag_t start_pos_tag : 4;
    ketl_hir_pos_tag_t end_pos_tag : 4;
};
...
KETL_DEFINE(ketl_hir_builder_t) {
    ...
    ketl_hir_var_id_t temp_vars_count;
