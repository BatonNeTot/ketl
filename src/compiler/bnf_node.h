...
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_4 7
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_5 8
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_6 9
#define KETL_SYNTAX_BUILDER_TYPE_DEFINE_WITH_ASSIGNMENT 10
#define KETL_SYNTAX_BUILDER_TYPE_RETURN 11
