...
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_2 5
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_4 6
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_5 7
#define KETL_SYNTAX_BUILDER_TYPE_PRECEDENCE_EXPRESSION_6 8
#define KETL_SYNTAX_BUILDER_TYPE_DEFINE_WITH_ASSIGNMENT 9
#define KETL_SYNTAX_BUILDER_TYPE_RETURN 10
