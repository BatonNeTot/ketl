            ...
            if (p_primitive_type->isInteger) {
                ANN_SWITCH_STRICT (p_primitive_type->size) {
                    case 1:
                        ...
                        break;
                    case 2:
                        p_variable->type = p_primitive_type->isSigned ? KETL_VARIABLE_INT16 : KETL_VARIABLE_UINT16;
                        break;
                    case 4:
                        p_variable->type = p_primitive_type->isSigned ? KETL_VARIABLE_INT32 : KETL_VARIABLE_UINT32;
                        break;
                    case 8:
                        p_variable->type = p_primitive_type->isSigned ? KETL_VARIABLE_INT64 : KETL_VARIABLE_UINT64;
                        break;
                }
            } else {
                ANN_SWITCH_STRICT (p_primitive_type->size) {
