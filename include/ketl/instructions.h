...
#define KETL_INSTRUCTION_CODE_ASSIGN_8_BYTES 55

#define KETL_INSTRUCTION_CODE_RETURN 56
#define KETL_INSTRUCTION_CODE_RETURN_8_BYTES 57

#define KETL_INSTRUCTION_RESERVED_ARGUMENTS_COUNT 1

KETL_DEFINE(KETLInstruction) {
	union {
		KETLInstructionCode code;
		KETLInstructionArgumentType argumentTypes[8]; // first KETL_INSTRUCTION_RESERVED_ARGUMENTS_COUNT are reserved
